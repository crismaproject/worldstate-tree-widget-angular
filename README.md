worldstate-tree-widget-angular   [![Build Status](http://ci.cismet.de/buildStatus/icon?job=worldstate-tree-widget-angular)](https://ci.cismet.de/view/html5%20javascript/job/worldstate-tree-widget-angular/)
==============================
