  ...
  grunt.initConfig({
    ...
    replace: {
        ...
        debugCode: {
            ...
            src: ['.tmp/concat/scripts/crisma-worldstate-tree-widget-angular.min.js'],
            dest: ['.tmp/concat/scripts/crisma-worldstate-tree-widget-angular.min.js'],
            replacements: [
    ...
    concat_css: {
        all: {
            ...
            dest: '<%= yeoman.dist %>/styles/crisma-worldstate-tree-widget-angular.css'
        }
    }
  });
